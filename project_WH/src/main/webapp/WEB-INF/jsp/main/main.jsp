    ...
    <script type="text/javascript">
        $(document).ready(function() {
                    ...
                    $("#insertbtn").click(function() {
                        var sgg_CQL = "sgg_cd="+$("#sgg option:checked").val(); // 시군구 선택 정보 가져오기
        ...
        <div class="main">
            <div class="btncon">
                ...
                <select id="styleSelect">
                    <option selected="selected" value="">범례 선택</option>
                    <option value="1">EqualInterval</option>
                    <option value="2"> NaturalBreaks</option>
                </select>
